...
The current stable release is [v0.1.29](https://github.com/GuanceCloud/obs-agent-connector/releases/tag/v0.1.29). See the [release notes](docs/releases/v0.1.29.md) for changes and compatibility details.
...
VERSION=v0.1.29 ./scripts/build-release.sh
```
