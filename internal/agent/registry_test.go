...
func TestSupportedNamesForWindows(t *testing.T) {
	expected := []string{"claude", "codebuddy", "codex", "cursor", "dcode", "dsh", "grok", "kiro", "omp", "openclaw", "opencode", "pi", "qoder", "workbuddy"}
...
func TestSupportedNamesForLinux(t *testing.T) {
	expected := []string{"claude", "codebuddy", "codex", "cursor", "dcode", "dsh", "grok", "hermes", "kiro", "omp", "openclaw", "opencode", "pi", "qoder"}
